...
export default function Landing() {
  ...
  return (
    <main className="relative min-h-screen bg-[#05000D] text-white overflow-hidden">
      ...
      {/* ===== ФИКСИРОВАННЫЙ ХЭДЕР-«ОСТРОВ» ===== */}
      <header className="fixed top-4 inset-x-0 z-30 flex justify-center px-3 sm:px-4">
        <div className="pointer-events-auto w-full max-w-5xl flex items-center gap-3 sm:gap-5 rounded-full border border-white/12 bg-black/70 px-4 sm:px-6 py-2 sm:py-2.5 shadow-[0_0_40px_rgba(15,23,42,0.9)] backdrop-blur-2xl">
          {/* ЛОГО / НЭЙМ */}
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 rounded-full bg-gradient-to-tr from-emerald-400 via-sky-400 to-violet-500 flex items-center justify-center text-[10px] font-bold shadow-[0_0_16px_rgba(56,189,248,0.9)]">
              CX
            </div>
          ...
          {/* НАВИГАЦИЯ */}
          <nav className="hidden md:flex items-center gap-4 text-[12px] text-neutral-200/80">
            <Link
              href="#home"
              className="px-3 py-1 rounded-full bg-white/10 text-white shadow-[0_0_18px_rgba(255,255,255,0.18)]"
            >
              Home
            </Link>
          ...
          <div className="ml-auto flex items-center gap-2 text-[11px] sm:text-xs">
            ...
            <Link href="/auth/register">
              <Button className="h-8 sm:h-9 px-4 sm:px-5 text-[11px] sm:text-xs font-medium rounded-full bg-white text-black shadow-[0_0_20px_rgba(255,255,255,0.75)] hover:bg-neutral-200 transition-colors">
                Get Started
              </Button>
            </Link>
          </div>
      ...
      <div className="pt-28 sm:pt-32 md:pt-36">
        ...
        <section
          id="home"
          className="scroll-mt-32 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 pb-14 sm:pb-16 lg:pb-20"
        >
          <div className="flex flex-col items-center text-center">
            {/* БЕЙДЖ */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/7 border border-white/15 text-[10px] sm:text-[11px] uppercase tracking-[0.24em] text-neutral-200/90 mb-4">
            ...
            {/* ПОДЗАГОЛОВОК */}
            <p className="mt-3 sm:mt-4 text-[13px] sm:text-sm md:text-base max-w-xl text-neutral-200/85">
              CallXAI подключается к вашей CRM и телефонии, расшифровывает каждый
              звонок, оценивает скрипт и показывает, где отдел продаж зарабатывает,
              а где сливает деньги.
            </p>
            ...
            <div className="mt-7 mb-5 flex flex-wrap justify-center gap-3 sm:gap-4">
              ...
              <Link href="/auth/login">
                <button className="rounded-full px-7 py-2.5 text-sm sm:text-base border border-white/20 bg-white/5 text-neutral-100 hover:bg-white/10 hover:border-white/35 transition-colors">
                  Смотреть отчёты
                </button>
              </Link>
            </div>
          ...
          {/* ДВЕ 3D-КАРТОЧКИ НИЖЕ HERO */}
          <div className="mt-10 sm:mt-12 lg:mt-14 grid gap-5 sm:gap-6 md:grid-cols-2">
            {/* Левая карточка */}
        ...
        >
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-sm md:text-base text-neutral-300 max-w-2xl mx-auto mt-3">
              Вы даёте доступ к CRM и телефонии — мы настраиваем поток звонков и
              уже через несколько часов вы видите живую картинку по отделу продаж.
            </p>
          </div>
          ...
          <div className="grid gap-5 sm:gap-6 md:grid-cols-4">
            {[
              ...
              <div
                key={i}
                className="relative rounded-3xl bg-white/[0.04] border border-white/10 backdrop-blur-xl p-4 sm:p-5 flex flex-col gap-3 min-h-[160px] shadow-[0_18px_40px_rgba(0,0,0,0.7)]"
              >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div
                ...
                className="rounded-3xl border border-white/12 bg-gradient-to-br from-white/[0.04] via-slate-900/70 to-violet-900/50 backdrop-blur-xl p-6 flex flex-col gap-2 shadow-[0_20px_45px_rgba(0,0,0,0.7)]"
              >
        ...
        >
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-semibold mt-2">
              Платите только за объём звонков
            </h2>
          </div>
            ...
            {[
              {
                title: "Start",
                price: "49 000 ₸ / мес",
                sub: "Небольшой отдел продаж, тест гипотез",
                features: [
                  "до 1 000 звонков",
                  "AI-расшифровка и базовые отчёты",
                  "интеграция с CRM",
                ],
                highlight: false,
              },
              {
                title: "Pro",
                price: "129 000 ₸ / мес",
                sub: "Активные команды, которые хотят расти",
                features: [
                  "до 5 000 звонков",
              ...
              <div
                ...
                className={`relative rounded-3xl p-[1px] ${
                  plan.highlight
                    ? "bg-gradient-to-br from-emerald-400 via-sky-400 to-violet-500 shadow-[0_0_45px_rgba(59,130,246,0.7)]"
                    : "bg-white/10 shadow-[0_16px_38px_rgba(0,0,0,0.7)]"
                }`}
              >
        ...
        {/* ===== ФИНАЛЬНЫЙ CTA ===== */}
        <section className="w-full border-t border-white/10 bg-black/40">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14 lg:py-16 text-center">
            ...
            <Link href="/auth/register">
              <Button className="h-11 px-8 text-sm sm:text-base rounded-full bg-gradient-to-r from-emerald-400 via-sky-400 to-violet-500 text-black font-medium hover:brightness-110 shadow-[0_0_35px_rgba(56,189,248,0.7)]">
